...
enum OutputFormat { SMF, PM, MMF, LOG, IV, VRML, PLY };
...
extern char* input_ply_filename; // added by ht
extern char input_smf_filename[500]; // added by ht
