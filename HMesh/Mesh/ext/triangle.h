...
/*  `trianglearealist':  An array of triangle area constraints; one TRIANGLE_REAL per */
/*    triangle.  Input only.                                                 */
...
/* #define SINGLE */
		...
		void trifree(void *memptr); //it is VOID before, as VOID is defined into int in  cpp, so we made the change
#else /* not ANSI_DECLARATORS */
		void triangulate();
		void trifree();
#endif /* not ANSI_DECLARATORS */
		int fast_expansion_sum_zeroelim(int elen, TRIANGLE_REAL *e, int flen, TRIANGLE_REAL *f, TRIANGLE_REAL *h);
