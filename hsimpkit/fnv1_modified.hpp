...
/***************************************************
   taken from boost source code and namespace 
   modified for the identifier collision in vs2010 
                                          - houtao
****************************************************/
...
#ifndef __BOOST_UNORDERED_HASHNM_FNV1_MODIFIED__
#define __BOOST_UNORDERED_HASHNM_FNV1_MODIFIED__

#include <string>

// namespace modified from 'hash' to 'hash_nm' due to name collision
// in vs2010, note !!
namespace hash_nm
{
...
#endif // __BOOST_UNORDERED_HASHNM_FNV1_MODIFIED__